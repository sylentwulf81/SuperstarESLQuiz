...
const EN = {
  ...
  steps: [
    ...
    'Gold Star and Bowser’s Revolution always end the round after their effect. Mystery Blocks can end the round only if the Piranha Plant is hit.',
    'You advance to the next question. Nothing auto-skips after a card.',
  ],
  cards: [
    'Super Mushroom: doubles that team’s next coin payout.',
    'Blue Shell: 1st place skips their next coin payout.',
...
const JA = {
  ...
  steps: [
    ...
    'ゴールドスターとクッパレボリューションは効果のあと必ずラウンド終了。ミステリーブロックはパックンフラワーのときだけ終了します。',
    '次の問題へ進むのはホストがボタンを押したときです。',
  ],
  cards: [
    'スーパーキノコ：次のコイン獲得が2倍。',
    'ブルースシェル：1位は次のコイン獲得をスキップ。',
