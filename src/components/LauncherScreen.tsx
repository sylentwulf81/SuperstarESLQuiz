...
import { LAUNCHER_GAMES, LauncherGame, GameCategory } from '../data/launcherGames';
import { sounds } from '../utils/sound';
import { MarioCoin } from './MarioCoin';
import { AccountMenu } from './AccountMenu';
import { SnesBoxArt } from './SnesBoxArt';

interface LauncherScreenProps {
  onLaunchGame: (themeKey?: GameTheme) => void;
  onOpenQuestionStudio: (themeKey?: GameTheme) => void;
  onOpenRulebook: () => void;
              ...
              <div className="flex flex-wrap items-center gap-3 pt-4">
                <button
                  onClick={() => {
                    ...
                    onLaunchGame(spotlightGame.themeKey);
                  }}
                ...
                {spotlightGame.hasQuestionStudio && (
                  <button
                    onClick={() => {
                      sounds.playClick();
                      onOpenQuestionStudio(spotlightGame.themeKey);
                    }}
                        ...
                        {game.hasQuestionStudio ? (
                          <div className="grid grid-cols-2 gap-2">
                            ...
                            <button
                              onClick={() => {
                                sounds.playClick();
                                onOpenQuestionStudio(game.themeKey);
                              }}
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {previewGame.hasQuestionStudio && (
                      <button
                        onClick={() => {
                          sounds.playClick();
                          setPreviewGame(null);
                          onOpenQuestionStudio(previewGame.themeKey);
                        }}
                    ...
                    <button
                      onClick={() => {
                        sounds.playGameStart();
                        setPreviewGame(null);
                        onLaunchGame(previewGame.themeKey);
                      }}
